...
- Production-retention/юридические тексты согласий по 152-ФЗ зафиксированы как отдельная обязательная задача перед production-релизом.

## Проверки

Тестирование пятого спринта намеренно не добавлялось: оно будет выполнено отдельным этапом. Для быстрой проверки сборки в совместимом Java 21 окружении используйте:
